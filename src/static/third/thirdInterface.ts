import { ThirdInterface } from './index';
import { xwfuGet, post } from '@static/js/http/http';


const getThirdConfig = () => {
    if (import.meta.env.VITE_APP_THIRD_CONFIG == 'guohui') {
        return class ThirdConfig implements ThirdInterface {
...
export const ThirdConfig = getThirdConfig();
