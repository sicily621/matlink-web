...
export const validateCode = (data: Employee) => Post(employeePrefix + "/validateCode", data);
export const validateUsername = (data: Employee) => Post(employeePrefix + "/validateUsername", data);
