          ...
          <div class="d-flex flex-1 align-items-center justify-content-between">
            <div class="d-flex align-items-center">
              <div class="title d-flex w-150">
                ...
                <span>{{ i18nM("material.title.stockInReview") }}</span>
              </div>
...
import { stockIn, postInStockApprovedList, queryInStockApprovedListParams } from "@functions/serviceCenter/material-management/api/instock";
...
import Create from "@functions/serviceCenter/material-management/stockInApprove/create.vue";
import StockInApprove from "@functions/serviceCenter/material-management/stockInApprove/stockInApprove.svg";
...
const refreshTable = () => {
  ...
  const params: queryInStockApprovedListParams = {
