...
import { purchasingRequisitionApprovedList } from "@functions/serviceCenter/material-management/api/purchasingRequisition";
...
import Create from "@functions/serviceCenter/material-management/purchaseApprove/create.vue";
