          ...
          <div class="d-flex flex-1 align-items-center justify-content-between">
            <div class="d-flex align-items-center">
              <div class="title d-flex w-150">
                ...
                <span>{{ i18nM("material.title.materialRequisition") }}</span>
              </div>
                ...
                <baseTable :columns="columns" :table-data="tableData" :indexMethod="indexMethod(currentPage, pageSize)">
                  ...
                  <template #operate="scope">
                    <IconSvg
                      ...
                      v-if="hasPermission(PermissionType.Update, permissions) && scope.scope.row.status === 0 && scope.scope.row.applyStatus === 0"
                    ...
                    <template v-if="scope.scope.row.status == 0 && scope.scope.row.applyStatus === 0">
                      <el-icon
                        class="fz20 m-r-20 pointer"
...
import Create from "@functions/serviceCenter/material-management/materialOutBoundApply/create.vue";
import Abandon from "@functions/serviceCenter/material-management/materialOutBoundApply/abandon.svg";
