  ...
  <div class="d-flex h-full w-full">
          ...
          <div class="d-flex flex-1 align-items-center justify-content-between">
            <div class="d-flex align-items-center">
              <div class="title d-flex w-150">
                ...
                <span>{{ i18nM("material.title.stockOutReview") }}</span>
              </div>
    ...
    <div class="flex-1 flex-column h-full create-wrap w-full" v-if="processFlag && currentData">
      ...
      <div class="zc-footer p-r-20 p-l-20 d-flex align-items-center" style="justify-content: flex-end">
        <div>
          <el-button :type="'primary'" class="m-r-16 w-80" v-if="processFlag === 1 && approve" @click="save()">{{
...
import { stockOut, postOutStockApprovedList, queryOutStockApprovedListParams } from "@functions/serviceCenter/material-management/api/outstock";
...
import Create from "@functions/serviceCenter/material-management/stockOutApprove/create.vue";
import StockOutApprove from "@functions/serviceCenter/material-management/stockOutApprove/stockOutApprove.svg";
...
const refreshTable = () => {
  ...
  const params: queryOutStockApprovedListParams = {
  ...
  postOutStockApprovedList(params, (res: any) => {
