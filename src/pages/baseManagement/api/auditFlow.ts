...
export const batchEditAuditFlow = (data: Partial<AuditFlow>[]) => Put(`${auditFlowPrefix}/batchUpdate`, data);
...
export const getAuditFlowList = (data: any) => Get(`${auditFlowPrefix}/list`, data);
