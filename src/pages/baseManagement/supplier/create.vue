    ...
    <el-card class="w-full h-full">
      ...
      >
        <div class="width-300 d-flex">
          ...
          <el-form-item label="简称" prop="simpleNo">
            <el-input
          ...
          <el-form-item label="编码" prop="supplierNo">
            <el-input
        ...
        <div class="width-300 d-flex m-l-16">
          ...
          <div class="width-300 flex">
            <el-form-item label="状态" prop="status" class="flex-1 m-r-2">
            ...
            <el-form-item label="级别" prop="level" class="flex-1">
...
const form = ref<Supplier>({
  supplierNo: `${ModuleCode.Supplier}${formatTimeToString()}`,
  simpleNo: "",
  name: "",
  address: "",
  mainBusiness: "",
...
const rules = reactive({
  ...
  supplierNo: [{ required: true, message: "不能为空" }],
  linkMan: [{ required: true, message: "不能为空" }],
