//物料分类
export const categoryPrefix = `/material/category`;
//物料单位
export const unitPrefix = `/material/unit`;
//供应商
...
//审批记录
export const auditFlowDetailRelationPrefix = `/audit/flow/detail/relation`;