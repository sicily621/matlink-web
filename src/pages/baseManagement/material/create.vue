  ...
  <div class="flex flex-col">
    <el-card class="w-full h-full">
      ...
      >
        ...
        <div class="width-300 d-flex m-l-16">
          ...
          <el-form-item label="安全库存量" prop="safeCountLimit">
            <el-input-number
              ...
              required
              :step="1"
              :min="form.minCountLimit"
              :max="form.maxCountLimit"
            >
            </el-input-number>
          </el-form-item>
          ...
          <el-form-item label="参考进价(元)" prop="standardCost">
            <el-input-number
        ...
        <qrcode-vue :value="codeValue" :level="level" :render-as="renderAs" :size="size" />
      </div>
      </el-form>
